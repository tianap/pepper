...
class DataStore(object):
    ...
    def write_summary(self, region, image, label, position, index, chunk_id, summary_name, ref_seq, coverage):
        ...
        if summary_name not in self.meta['summaries']:
            ...
            self.file_handler['{}/{}/{}'.format(self._summary_path_, summary_name, 'coverage')] = coverage
