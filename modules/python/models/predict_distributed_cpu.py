...
def predict(input_filepath, file_chunks, output_filepath, transducer_model, batch_size, num_workers, thread_id):
...
def predict_distributed_cpu(filepath, file_chunks, output_filepath, model_path, batch_size, threads, num_workers):
    """
